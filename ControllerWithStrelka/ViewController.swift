...
//  ControllerWithStrelka
//
//  Created by Эллина Коржова on 15.05.23.
//
...
class ChildController: UIViewController {
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = .init(systemItem: .close, primaryAction: .init(handler: { _ in self.dismiss(animated: true)}))
